function [Wp] = palm_2turb_adm_turbl()

Wp = struct('description','2 NREL 5MW turbines case, turbulent inflow, based on a PALM ADM simulation');
...
Wp.site = struct(...
    'u_Inf',7.987,... % Initial long. wind speed in m/s
