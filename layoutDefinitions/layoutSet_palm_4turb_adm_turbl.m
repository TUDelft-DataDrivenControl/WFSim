...
Wp.site = struct(...
    ...
    'lm_slope',[.12 .1 .1 .1],... % Mixing length in x-direction (m)
    'd_lower',[73.3 73.3 73.3 73.3],... % Turbulence model gridding property
    'd_upper',[601.9 601.9 601.9 901.9],... % Turbulence model gridding property
