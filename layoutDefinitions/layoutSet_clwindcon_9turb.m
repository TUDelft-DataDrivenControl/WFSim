function [Wp] = layoutSet_clwindcon_9turb()
Wp = struct('description','9 DTU 10MW turbines case for the CL-Windcon project');
...
Wp.mesh = struct(...
    ...
    'Ly',16*178.3,... % Domain length in y-direction
