...
Wp.site = struct(...
    ...
    'lm_slope',0.10*ones(1,size(Wp.turbine.Crx,2)),... % Mixing length in x-direction (m)
    'd_lower',0.10*ones(1,size(Wp.turbine.Crx,2)),... % Turbulence model gridding property
    'd_upper',3.0*ones(1,size(Wp.turbine.Crx,2)),... % Turbulence model gridding property
