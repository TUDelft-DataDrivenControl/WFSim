...
#
# MACI64 - 
            NC4HDF5="/opt/netcdf-4.0.1"
           CFLAGS="-I${NC4HDF5}/include $CFLAGS"
           CLIBS="-L${NC4HDF5}/lib -lnetcdf -lhdf5_hl -lhdf5 -lz $CLIBS"
           CLIBS="${NC4HDF5}/lib/libnetcdf.a ${NC4HDF5}/lib/libhdf5_hl.a ${NC4HDF5}/lib/libhdf5.a -lz $CLIBS"
#
# GLNXA64 - library compile flags are 
#           CFLAGS="-fPIC" CXXFLAGS="-fPIC" --disable-shared
#            NC4HDF5="/home/johne/local/nc-4.0.1/glnxa64"
#           CFLAGS="-I${NC4HDF5}/include $CFLAGS"
#           CLIBS="-L${NC4HDF5}/lib -lnetcdf -lhdf5_hl -lhdf5 -lz $CLIBS"
#
# GLNX86 - library compile flags are 
#           --disable-shared
#            NC4HDF5="/home/johne/local/nc-4.0.1/glnx86"
#           CFLAGS="-I${NC4HDF5}/include $CFLAGS"
#           CLIBS="-L${NC4HDF5}/lib -lnetcdf -lhdf5_hl -lhdf5 $CLIBS"
#
#           FC="$FC"
#           FFLAGS="$FFLAGS"
