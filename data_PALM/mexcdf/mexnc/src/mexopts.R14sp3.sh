...
###     and "--disable-shared --enable-netcdf-4 --with-hdf5=/home/johne/local/nc4"
          ...
          CFLAGS="$CFLAGS -g -I${NETCDF}/include  "
          CLIBS="-L${NETCDF}/lib -lnetcdf -lhdf5_hl -lhdf5 -lz $CLIBS "
### glnx86
### vanilla netcdf-4 
### NetCDF library compiled with "--disable-shared --enable-netcdf-4 --with-hdf5=/home/johne/local/glnx86/netcdf-4.0
          HDF5="/home/johne/local/glnx86/hdf5-1.8.1"
          NETCDF="/home/johne/local/glnx86/netcdf-4.0"
          CFLAGS="$CFLAGS -g -I${NETCDF}/include  "
